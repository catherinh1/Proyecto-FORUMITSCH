    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <div class="container text-center py-5">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Especialidades</h1>
        ...
        <?php 
            ...
            <div class="col-md-3">
                <div class="card">
                    <img class="card-img-top" src="img/<?php echo $noticias['imagen']; ?>" height="250" alt="">
                    <div class="card-body">
                        <h4 class="card-title"><?php echo $noticias['nombre']; ?></h4>
                        <h4 class="card-title"><?php echo $noticias['precio']; ?></h4>
                        <div>
                        <a href="Cuenta.html" class="btn btn-primary">Detalles</a>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="row g-5">
                    <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                        <div class="h-100 position-relative">
                            <img src="img/logoTICS.png" class="img-fluid w-75 rounded" alt="" style="margin-bottom: 25%;">
                            <div class="position-absolute w-75" style="top: 25%; left: 25%;">
                                <img src="img/logoTICS.png" class="img-fluid w-100 rounded" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        <h5 class="text-primary">Clave del plan de estudios
                            ITIC-2010-225</h5>
                        <h1 class="mb-4">¿Qué es un ingeniero en Tecnologías de la información y Comunicaciones?</h1>
                        <p>El Ingeniero en Tecnologías de la Información y Comunicaciones es un profesional que se enfoca en el diseño, desarrollo e implementación de soluciones tecnológicas de vanguardia mediante programas, apps, gadgets, dispositivos, marketing digital e internet de las cosas.</p>
                        ...
                        <p class="mb-4">“Ser un programa educativo de vanguardia, acreditado y reconocido por su alta calidad académica en la formación de profesionistas en tecnologías de la información y comunicaciones, que sean capaces de desarrollar el sector tecnológico de su entorno de manera sustentable”.</p>
                        <h5 class="text-primary">Objetivo</h5>
